...
<head>
  ...
  <style>
    :root{--bg:#f8f6f1;--card:#fff;--accent:#c0392b;--accent2:#2980b9;--accent3:#0e7c66;--accent4:#5b4b8a;--accent5:#b7791f;--text:#2c3e50;--muted:#7f8c8d;--border:#ddd}
    *{box-sizing:border-box}
    ...
    .friends{border-left:5px solid var(--accent4)}
    .friends h2{color:var(--accent4)}
    .friends .go{background:var(--accent4)}
    .daily{border-left:5px solid var(--accent5)}
    .daily h2{color:var(--accent5)}
    .daily .go{background:var(--accent5)}
  </style>
</head>
<body>
  <div class="container">
    ...
    <div class="card practice">
      ...
      <a class="go" href="travel/index.html">Open Japan Trip</a>
      <div class="meta">Nothing is graded, and you speak instead of clicking.</div>
    </div>

    <div class="card friends">
      <h2>Practicing with Friends</h2>
      <p>Six short conversations between four friends: how the week went, weekends, food, places they have been, and making a plan. Everyone pairs with everyone across the set.</p>
      <a class="go" href="tomodachi/index.html">Open Practicing with Friends</a>
      <div class="meta">Built from Lessons 1 to 11 of the textbook plus the conversation course.</div>
    </div>

    <div class="card daily">
      <h2>Daily Practice</h2>
      <p>Fifteen lines a day, said out loud. Today's set opens automatically. Built from Lessons 1 to 12 of the textbook plus the conversation course, and it walks through the particles, the counters, the question words and every verb and adjective ending.</p>
      <a class="go" href="renshuu/index.html">Open Daily Practice</a>
      <div class="meta">Ten minutes. No partner needed.</div>
    </div>
    ...
    <div class="footer">
      <div>Use this page each week to start your quiz, or open either conversation section any time.</div>
    </div>
  </div>
</body>
</html>
